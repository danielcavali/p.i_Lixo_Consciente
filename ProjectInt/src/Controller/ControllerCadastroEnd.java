...
/**
 * Servlet implementation class ControllerCadastroEnd
 */
@WebServlet("/ControllerCadastroEnd")
public class ControllerCadastroEnd extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControllerCadastroEnd() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		email.enviaEmail(clie.getEmail(), clie.getNome_Cliente());
